...
/// <summary>
/// Validator for TrackImpressionDto
/// Validates: Requirements 7.1
/// </summary>
public class TrackImpressionDtoValidator : AbstractValidator<TrackImpressionDto>
{
    public TrackImpressionDtoValidator()
    {
        // Requirement 7.1: SessionId is required
        RuleFor(x => x.SessionId)
            .NotEmpty().WithMessage("Session ID is required")
            .MaximumLength(100).WithMessage("Session ID cannot exceed 100 characters");

        // Requirement 7.1: Page is required
        RuleFor(x => x.Page)
