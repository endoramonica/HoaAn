...
namespace VietCommerce.Tests.Api.Controllers
{
    ...
    /// NOTE: CampaignController is in the BE (AdminApi) project, not VietCommerce.Api
    /// This test class is disabled until the controller is available in the correct project
    /// </summary>
/*
