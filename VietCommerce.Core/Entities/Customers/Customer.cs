...
public class Customer : BaseEntity, ISoftDelete
{
    ...
    public string? Email { get; set; }           // th�m Email


    // Navigation properties
    public virtual ICollection<Cart> Carts { get; set; } = new List<Cart>(); // th�m Carts
    ...
    // Thêm vào Customer.cs
    [InverseProperty(nameof(CRMInteraction.Customer))]
    public ICollection<CRMInteraction> Interactions { get; set; } = new List<CRMInteraction>();
}