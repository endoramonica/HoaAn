        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualCost = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAddresses_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(15,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinOrderAmount = table.Column<decimal>(type: "decimal(15,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DiscountOverride = table.Column<decimal>(type: "decimal(15,2)", precision: 18, scale: 2, nullable: true),
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderStatusHistories_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "CustomerId",
                unique: true,
                filter: "CustomerId IS NOT NULL AND IsDeleted = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_StoreId_IsDeleted",
                table: "Inventories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CustomerId_IsDeleted",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_StoreId_CreatedAt_IsDeleted",
                table: "Orders",
                columns: new[] { "StoreId", "CreatedAt", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusHistories_CreatedByUserId",
