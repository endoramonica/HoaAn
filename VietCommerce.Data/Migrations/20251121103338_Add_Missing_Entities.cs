...
{
    /// <inheritdoc />
    public partial class Add_Missing_Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // 1. CRMInteractions Table
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CRMInteractions_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CRMInteractions_Users_UpdatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliverySchedule = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            // 4. StockTransfers Table
            migrationBuilder.CreateTable(
                name: "StockTransfers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FromWarehouse = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ToWarehouse = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransferItems_StockTransfers_StockTransferId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerRating = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosingCash = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CRMInteractions_CustomerId_CreatedAt",
                table: "CRMInteractions",
                columns: new[] { "CustomerId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CRMInteractions_Type",
                table: "CRMInteractions",
                column: "Type");

            migrationBuilder.CreateIndex(
                name: "IX_CRMInteractions_Status",
                table: "CRMInteractions",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_CRMInteractions_CreatedBy",
                table: "CRMInteractions",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_CRMInteractions_UpdatedBy",
                table: "CRMInteractions",
                column: "UpdatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransferItems_StockTransferId",
                table: "TransferItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceMetrics_EmployeeId_Period",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkSchedules_EmployeeId_Date",
                table: "WorkSchedules",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "CRMInteractions");
        }
    }
}