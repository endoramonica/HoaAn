# OrderDetailDtoPaginatedResponse
...
------------ | ------------- | ------------- | -------------
**items** | [**Array&lt;OrderDetailDto&gt;**](OrderDetailDto.md) |  | [optional] [default to undefined]
...
```typescript
import { OrderDetailDtoPaginatedResponse } from './api';

const instance: OrderDetailDtoPaginatedResponse = {
    items,
    pageNumber,
    pageSize,
    totalItems,
