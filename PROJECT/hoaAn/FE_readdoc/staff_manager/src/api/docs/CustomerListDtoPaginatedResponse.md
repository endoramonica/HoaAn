# CustomerListDtoPaginatedResponse
...
------------ | ------------- | ------------- | -------------
**items** | [**Array&lt;CustomerListDto&gt;**](CustomerListDto.md) |  | [optional] [default to undefined]
...
```typescript
import { CustomerListDtoPaginatedResponse } from './api';

const instance: CustomerListDtoPaginatedResponse = {
    items,
    pageNumber,
    pageSize,
    totalItems,
