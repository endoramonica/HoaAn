...
------------ | ------------- | ------------- | -------------
**items** | [**Array&lt;EmployeeDto&gt;**](EmployeeDto.md) |  | [optional] [default to undefined]
...
```typescript
import { EmployeeDtoPaginatedResponse } from './api';

const instance: EmployeeDtoPaginatedResponse = {
    items,
    pageNumber,
    pageSize,
    totalItems,
