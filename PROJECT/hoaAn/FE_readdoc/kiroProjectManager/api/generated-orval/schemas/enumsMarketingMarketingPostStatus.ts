...
export type EnumsMarketingMarketingPostStatus = typeof EnumsMarketingMarketingPostStatus[keyof typeof EnumsMarketingMarketingPostStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EnumsMarketingMarketingPostStatus = {
  draft: 'draft',
  published: 'published',
  scheduled: 'scheduled',
} as const;
