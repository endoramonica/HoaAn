 ...
 */
import type { WishlistProductInWishlistDto } from './wishlistProductInWishlistDto';

export interface WishlistWishlistItemDto {
  id?: string;
  userId?: string;
  productId?: string;
  product?: WishlistProductInWishlistDto;
  createdAt?: string;
}
