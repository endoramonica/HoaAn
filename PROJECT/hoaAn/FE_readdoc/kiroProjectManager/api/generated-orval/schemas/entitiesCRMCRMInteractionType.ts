...
export type EntitiesCRMCRMInteractionType = typeof EntitiesCRMCRMInteractionType[keyof typeof EntitiesCRMCRMInteractionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EntitiesCRMCRMInteractionType = {
  call: 'call',
  email: 'email',
  meeting: 'meeting',
  note: 'note',
