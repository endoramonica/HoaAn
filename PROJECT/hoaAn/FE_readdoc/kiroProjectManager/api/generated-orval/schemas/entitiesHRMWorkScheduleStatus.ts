...
export type EntitiesHRMWorkScheduleStatus = typeof EntitiesHRMWorkScheduleStatus[keyof typeof EntitiesHRMWorkScheduleStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EntitiesHRMWorkScheduleStatus = {
  scheduled: 'scheduled',
  confirmed: 'confirmed',
  completed: 'completed',
  missed: 'missed',
