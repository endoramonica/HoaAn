 ...
 */
import type { CustomersLoyaltyHistoryDto } from './customersLoyaltyHistoryDto';

export interface ApiResponseListCustomersLoyaltyHistoryDto {
  success?: boolean;
  /** @nullable */
  data?: CustomersLoyaltyHistoryDto[] | null;
  /** @nullable */
  message?: string | null;
  /** @nullable */
  errors?: string[] | null;
