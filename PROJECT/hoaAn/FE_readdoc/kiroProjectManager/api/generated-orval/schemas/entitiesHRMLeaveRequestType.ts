...
export type EntitiesHRMLeaveRequestType = typeof EntitiesHRMLeaveRequestType[keyof typeof EntitiesHRMLeaveRequestType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EntitiesHRMLeaveRequestType = {
  vacation: 'vacation',
  sick: 'sick',
  personal: 'personal',
  emergency: 'emergency',
