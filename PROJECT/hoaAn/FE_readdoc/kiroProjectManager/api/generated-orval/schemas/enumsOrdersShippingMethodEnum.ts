...
export type EnumsOrdersShippingMethodEnum = typeof EnumsOrdersShippingMethodEnum[keyof typeof EnumsOrdersShippingMethodEnum];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EnumsOrdersShippingMethodEnum = {
  standard: 'standard',
  express: 'express',
  sameDay: 'sameDay',
  overnight: 'overnight',
