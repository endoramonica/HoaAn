 ...
 */
import type { WishlistWishlistItemDto } from './wishlistWishlistItemDto';

export interface ApiResponseListWishlistWishlistItemDto {
  success?: boolean;
  /** @nullable */
  data?: WishlistWishlistItemDto[] | null;
  /** @nullable */
  message?: string | null;
  /** @nullable */
  errors?: string[] | null;
