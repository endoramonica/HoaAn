...
export type EntitiesHRMLeaveRequestStatus = typeof EntitiesHRMLeaveRequestStatus[keyof typeof EntitiesHRMLeaveRequestStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EntitiesHRMLeaveRequestStatus = {
  pending: 'pending',
  approved: 'approved',
  rejected: 'rejected',
} as const;
