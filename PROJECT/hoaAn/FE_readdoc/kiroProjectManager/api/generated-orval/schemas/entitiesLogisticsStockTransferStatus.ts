...
export type EntitiesLogisticsStockTransferStatus = typeof EntitiesLogisticsStockTransferStatus[keyof typeof EntitiesLogisticsStockTransferStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const EntitiesLogisticsStockTransferStatus = {
  pending: 'pending',
  inTransit: 'inTransit',
  delivered: 'delivered',
  cancelled: 'cancelled',
