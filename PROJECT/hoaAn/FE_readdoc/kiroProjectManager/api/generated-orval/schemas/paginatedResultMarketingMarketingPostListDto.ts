 ...
 */
import type { MarketingMarketingPostListDto } from './marketingMarketingPostListDto';

export interface PaginatedResultMarketingMarketingPostListDto {
  /** @nullable */
  items?: MarketingMarketingPostListDto[] | null;
  pageNumber?: number;
  pageSize?: number;
  totalItems?: number;
  totalPages?: number;
