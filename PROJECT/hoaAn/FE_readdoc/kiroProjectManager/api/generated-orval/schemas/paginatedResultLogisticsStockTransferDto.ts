 ...
 */
import type { LogisticsStockTransferDto } from './logisticsStockTransferDto';

export interface PaginatedResultLogisticsStockTransferDto {
  /** @nullable */
  items?: LogisticsStockTransferDto[] | null;
  pageNumber?: number;
  pageSize?: number;
  totalItems?: number;
  totalPages?: number;
