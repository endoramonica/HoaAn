...
export function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['support@docungonline.vn', 'contact@docungonline.vn'],
      color: 'text-blue-600'
    },
    {
      icon: MapPin,
      title: 'Địa chỉ',
      details: ['123 Đường Láng, Đống Đa, Hà Nội', 'Tầng 5, Tòa nhà ABC'],
      color: 'text-red-600'
    },
    {
      icon: Clock,
      title: 'Giờ làm việc',
      details: ['Thứ 2 - Chủ nhật: 8:00 - 22:00', 'Tư vấn 24/7 qua hotline'],
  ...
  const socialLinks = [
    ...
    { icon: MessageCircle, name: 'Zalo', url: '#', color: 'bg-blue-500' }
  ];
      ...
      <section className="relative py-20 bg-gradient-to-r from-amber-900 to-red-800 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-yellow-100 max-w-2xl mx-auto">
            Chúng tôi luôn sẵn sàng hỗ trợ và tư vấn cho bạn về các sản phẩm và dịch vụ
          </p>
        </div>
      </section>
            ...
            {contactInfo.map((info, index) => (
              <Card key={index} className="text-center hover:shadow-lg transition-shadow border-2 border-amber-200">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-lg text-amber-900 mb-3">{info.title}</h3>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <Card className="border-2 border-amber-200">
                <CardHeader>
                  <CardTitle className="text-xl text-amber-900">Vị trí cửa hàng</CardTitle>
                </CardHeader>
                <CardContent className="p-0">
                  <div className="w-full h-64 bg-gray-200 rounded-b-lg relative overflow-hidden">
                    <iframe
              ...
              <Card className="border-2 border-amber-200">
                <CardHeader>
                  <CardTitle className="text-xl text-amber-900">Kết nối nhanh</CardTitle>
                  <p className="text-gray-600">Liên hệ trực tiếp qua các kênh sau</p>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    <Button variant="outline" className="w-full border-blue-500 text-blue-600 hover:bg-blue-50 justify-start">
                      <MessageCircle className="w-4 h-4 mr-3" />
                      Chat Zalo: @docungonline
                    </Button>
                    <Button variant="outline" className="w-full border-red-500 text-red-600 hover:bg-red-50 justify-start">
                  ...
                  <div className="border-t pt-4">
                    <p className="text-sm text-gray-600 mb-3">Theo dõi chúng tôi:</p>
              ...
              <Card className="border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-yellow-100">
                <CardContent className="p-6">
                  <h3 className="text-lg text-amber-900 mb-3">Câu hỏi thường gặp</h3>
