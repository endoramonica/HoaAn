...
export class OrderService {
     ...
     * @throws ApiError
     */
    public static getApiV1OrderMyOrders(
        page?: number,
        pageSize?: number,
        keyword?: string,
        customerId?: string,
     ...
     * @throws ApiError
     */
    public static getApiV1OrderSearch(
        q?: string,
     ...
     * @throws ApiError
     */
    public static getApiV1OrderStatus(
        status: OrderStatus,
    ): CancelablePromise<OrderDetailDtoListApiResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getApiV1OrderRecent(
        count: number = 10,
        storeId?: string,
    ): CancelablePromise<OrderDetailDtoListApiResponse> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getApiV1OrderStatusHistory(
        orderId: string,
     ...
     * @throws ApiError
     */
    public static putApiV1OrderStatus(
        orderId: string,
     ...
     * @throws ApiError
     */
    public static getApiV1OrderCanChangeStatus(
        orderId: string,
     ...
     * @throws ApiError
     */
    public static getApiV1OrderStatsCount(
        storeId?: string,
        fromDate?: string,
        toDate?: string,
     ...
     * @throws ApiError
     */
    public static getApiV1OrderStatsRevenue(
        storeId?: string,
        fromDate?: string,
        toDate?: string,
     ...
     * @throws ApiError
     */
    public static postApiV1OrderBulkUpdateStatus(
