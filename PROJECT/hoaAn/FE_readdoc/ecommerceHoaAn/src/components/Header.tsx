...
import { Flower2, Menu, ShoppingCart, User, Phone, Truck, Flower, MessageCircle, Users, HelpCircle, Heart, LogIn } from 'lucide-react';
            ...
            {navItems.map((item) => (
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${
                  currentPage === item.id || (item.id === '' && currentPage === 'home')
                ...
                <div className="border-t border-gray-200 pt-4 mt-6">
                  ...
                  <div className="flex gap-2">
                    <Button 
                      ...
                      onClick={() => handleNavigation(isAuthenticated ? '/profile' : '/auth/login')}
                    >
                      <User className="w-4 h-4" />
                    </Button>
                    <Button 
