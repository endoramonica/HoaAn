...
export function ProfilePage() {
  ...
  const [addresses, setAddresses] = useState<Address[]>([
    ...
    },
    {
      ...
      name: 'Nguyễn Văn An',
      phone: '0912 345 678',
      address: '456 Nguyễn Trãi, Phường Thanh Xuân Trung, Quận Thanh Xuân, Hà Nội',
      isDefault: false
    }
  ]);
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-3xl md:text-4xl mb-2">Xin chào, {userInfo.name}</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-5 bg-white border-2 border-amber-200">
            ...
            <TabsTrigger value="addresses" className="data-[state=active]:bg-amber-100 data-[state=active]:text-amber-900">
              <MapPin className="w-4 h-4 mr-2" />
              <span className="hidden sm:inline">Địa chỉ</span>
            </TabsTrigger>
            <TabsTrigger value="notifications" className="data-[state=active]:bg-amber-100 data-[state=active]:text-amber-900">
              <Bell className="w-4 h-4 mr-2" />
              <span className="hidden sm:inline">Thông báo</span>
            </TabsTrigger>
            <TabsTrigger value="security" className="data-[state=active]:bg-amber-100 data-[state=active]:text-amber-900">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="text-sm text-gray-700 mb-2 block">Họ và tên</label>
                    <Input
                      value={userInfo.name}
                  ...
                  <div>
                    <label className="text-sm text-gray-700 mb-2 block">Số điện thoại</label>
                    <Input
                  ...
                  <div>
                    <label className="text-sm text-gray-700 mb-2 block">Ngày sinh</label>
                    <Input
                      type="date"
                ...
                <Card className="bg-gradient-to-r from-amber-50 to-yellow-100 border-amber-200">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg text-amber-900">Quyền lợi thành viên VIP</h3>
                    </div>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 text-green-600" />
                        <span className="text-sm">Giảm giá 15% tất cả đơn hàng</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 text-green-600" />
                      ...
                      <div className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 text-green-600" />
                        <span className="text-sm">Tư vấn phong thủy miễn phí</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                        ...
                        <div className="flex flex-col lg:flex-row gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex flex-wrap items-center gap-4 mb-3">
                              <h3 className="text-amber-900">Đơn hàng #{order.id}</h3>
                          ...
                          <div className="flex flex-col items-end gap-2">
                            <div className="text-lg text-red-600">{formatPrice(order.total)}</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {addresses.map((address) => (
                    <Card key={address.id} className={`border-2 ${address.isDefault ? 'border-amber-300 bg-amber-50' : 'border-gray-200'}`}>
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              {address.isDefault && (
                                <Badge className="bg-amber-600 text-white text-xs">Mặc định</Badge>
                              )}
                            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 border border-amber-200 rounded-lg">
                    <div>
                      <h3 className="text-amber-900 mb-1">Khuyến mãi & Ưu đãi</h3>
                  ...
                  <div className="flex items-center justify-between p-4 border border-amber-200 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Nhận bản tin về phong thủy và nghi lễ</p>
                    </div>
                    <Switch
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="p-4 border border-amber-200 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 mb-4">Cập nhật mật khẩu để bảo mật tài khoản</p>
                  ...
                  <div className="p-4 border border-amber-200 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 mb-4">Tăng bảo mật với xác thực qua SMS</p>
                    <div className="flex items-center justify-between">
                  ...
                  <div className="p-4 border border-amber-200 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 mb-4">Quản lý các thiết bị đã đăng nhập</p>
                    <Button variant="outline" className="border-amber-300 text-amber-700 hover:bg-amber-50">
                      Xem chi tiết
                    </Button>
                  </div>
                  ...
                  <div className="p-4 border border-blue-200 rounded-lg bg-blue-50">
                    ...
                    <p className="text-sm text-blue-700 mb-4">Đăng xuất khỏi tài khoản trên thiết bị này</p>
                    <Button 
                      variant="outline" 
                  ...
                  <div className="p-4 border border-red-200 rounded-lg bg-red-50">
                    ...
                    <p className="text-sm text-red-700 mb-4">Xóa vĩnh viễn tài khoản và dữ liệu</p>
