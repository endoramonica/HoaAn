    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-2 z-50">
      <div className="flex justify-around">
        ...
        <button
          ...
          className={`flex flex-col items-center py-2 px-3 rounded-lg transition-colors ${
            activeTab === 'delivery' ? 'text-green-600 bg-green-50' : 'text-gray-500'
          }`}
        >
          <Plus className="w-5 h-5 mb-1" />
          <span className="text-xs">Đặt giao</span>
        </button>
        <button
          onClick={() => {
          ...
          className={`flex flex-col items-center py-2 px-3 rounded-lg transition-colors ${
            activeTab === 'profile' ? 'text-green-600 bg-green-50' : 'text-gray-500'
          }`}
        >
      ...
      <div className="max-w-md mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card
            ...
            onClick={() => navigate('/delivery/booking')}
          >
          ...
          <Card
            ...
            onClick={() => navigate('/delivery/price-estimation')}
          >
            <div className="flex flex-col items-center text-center">
            ...
            {recentOrders.map((order) => (
              <Card key={order.id} className="p-4">
                ...
                <Button
                  ...
                  size="sm"
                  className="w-full"
                  onClick={() => navigate('/delivery/order-details')}
                >
                  Xem chi tiết
                </Button>
              </Card>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <button
              onClick={() => navigate('/delivery/driver-rating')}
              className="flex flex-col items-center p-3 bg-white rounded-lg border hover:shadow-md transition-shadow"
            >
