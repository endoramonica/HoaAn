...
import { useNavigate } from "react-router-dom"; // ← react-router-dom only
import {
  Users,
  Heart,
  Award,
...
export function AboutPage() {
  const navigate = useNavigate(); // ← Clean, URL-based navigation
  ...
  const values = [
    {
      ...
      title: "Sứ mệnh",
      description:
        "Mang đến cho mọi gia đình Việt Nam những sản phẩm đồ cúng chất lượng cao, giúp các nghi lễ truyền thống được thực hiện một cách chuẩn xác và ý nghĩa.",
    },
    {
      icon: Award,
      title: "Tầm nhìn",
      description:
        "Trở thành thương hiệu đồ cúng trực tuyến hàng đầu Việt Nam, góp phần bảo tồn và phát huy những giá trị văn hóa truyền thống của dân tộc.",
    },
    {
      icon: Sparkles,
      title: "Giá trị cốt lõi",
      description:
        "Chất lượng - Tôn trọng - Truyền thống - Đổi mới. Chúng tôi luôn đặt chất lượng sản phẩm và sự hài lòng của khách hàng lên hàng đầu.",
    },
  ];
  ...
  const team = [
    {
      ...
      description:
        "Với hơn 20 năm kinh nghiệm trong lĩnh vực văn hóa tâm linh, ông Minh đã dẫn dắt công ty phát triển vững mạnh.",
      image:
    ...
    },
    {
      ...
      description:
        "Chuyên gia hàng đầu về các sản phẩm đồ cúng truyền thống, đảm bảo chất lượng theo tiêu chuẩn cao nhất.",
      image:
    ...
    },
    {
      ...
      description:
        "Thầy phong thủy nổi tiếng với kinh nghiệm tư vấn nghi lễ cho hàng nghìn gia đình trên toàn quốc.",
      image:
        ...
        <section className="relative py-20 bg-gradient-to-r from-amber-900 to-red-800 text-white overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-yellow-100 max-w-3xl mx-auto leading-relaxed">
              Đồ Cúng Online được thành lập với sứ mệnh mang đến
              cho mọi gia đình Việt Nam những sản phẩm đồ cúng
              chất lượng cao, giúp bảo tồn và phát huy các giá
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                <Card
                  key={index}
                  className="text-center border-2 border-amber-200 hover:border-amber-400 transition-colors"
                >
                  <CardContent className="p-6">
                    ...
                    <div className="text-3xl text-amber-900 mb-2">
                      {stat.number}
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Đồ Cúng Online ra đời từ mong muốn giúp các
                    gia đình Việt Nam duy trì những truyền thống
                    văn hóa tâm linh quý báu trong cuộc sống
                    hiện đại.
                  </p>
                  <p>
                    Khởi đầu từ một cửa hàng nhỏ tại Hà Nội năm
                    2008, chúng tôi đã không ngừng phát triển và
                    hoàn thiện để trở thành một trong những
                    thương hiệu đồ cúng trực tuyến uy tín nhất
                    Việt Nam.
                  </p>
                  <p>
                    Với đội ngũ chuyên gia am hiểu sâu sắc về
                    văn hóa tâm linh và công nghệ hiện đại,
                    chúng tôi mang đến những sản phẩm và dịch vụ
                    chất lượng cao, phù hợp với nhu cầu của từng
                    gia đình.
                  </p>
                </div>
                <Button
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Những giá trị cốt lõi định hướng mọi hoạt động
                của chúng tôi
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {values.map((value, index) => (
                <Card
                  key={index}
                  className="text-center border-2 border-amber-200 hover:border-amber-400 hover:shadow-lg transition-all"
                >
                  <CardHeader>
                    <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-amber-400 to-red-500 rounded-full flex items-center justify-center">
        ...
        <section className="py-16 bg-gradient-to-br from-red-50 to-yellow-50">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Những con người tâm huyết, giàu kinh nghiệm đứng
                sau thành công của chúng tôi
              </p>
            </div>
              ...
              {team.map((member, index) => (
                ...
                >
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-xl text-amber-900 mb-2">
                      {member.name}
                    </h3>
            ...
            <div className="grid md:grid-cols-4 gap-6 mt-12">
              {[
                ...
                },
                {
                  ...
                  year: "Quản lý chất lượng",
                },
                {
                  icon: Users,
                  title: "Top 10 thương hiệu",
                  year: "Uy tín Việt Nam",
                },
                {
                  icon: Sparkles,
